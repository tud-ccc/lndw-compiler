...
## Usage
To run the app, clone the repository and run `cargo run` (`--release`) in its root directory. This requires a Rust installation; the minimum supported Rust version (MSRV) is 1.92.
